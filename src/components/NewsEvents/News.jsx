    ...
    const fetchData = async () => {
      try {
        ...
        const articlesRes = await axios.get(
          `${import.meta.env.VITE_BACKEND_URL}/api/news/articles`
        );
        ...
        const eventsRes = await axios.get(
          `${import.meta.env.VITE_BACKEND_URL}/api/news/events`
        );
        ...
        const mediaRes = await axios.get(
          `${import.meta.env.VITE_BACKEND_URL}/api/news/media`
        );
      ...
      if (result.isConfirmed) {
        try {
          ...
          const updatedEvent = await axios.put(
            `${import.meta.env.VITE_BACKEND_URL}/api/news/events/${event._id}`,
            {
